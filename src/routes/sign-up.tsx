...
export const Route = createFileRoute("/sign-up")({
  head: () => ({
    meta: [{ title: "Rejestracja konta" }, { name: "robots", content: "noindex, nofollow" }],
  }),
...
function SignUpPage() {
  ...
  return (
    <AuthCard
      title="Utwórz konto"
      description="Wyślemy wiadomość z linkiem potwierdzającym adres e-mail."
      footer={
        <>
          Masz już konto?{" "}
      ...
      <form
        ...
        onSubmit={(event) => {
          ...
          void signUp({
            ...
            .catch((cause: unknown) =>
              setError(
                cause instanceof ApiRequestError ? cause.message : "Nie udało się utworzyć konta.",
              ),
            )
